...
struct UIList<MessageContent: View, InputView: View>: UIViewRepresentable {
    ...
    func applyOperation(_ operation: Operation, tableView: UITableView) {
        ...
        case .edit(let section, let row):
            // Use reloadRows instead of reconfigureRows to ensure SwiftUI hosted cells fully refresh
    ...
    func makeCoordinator() -> Coordinator {
        Coordinator(
            ...
            showMessageTimeView: showMessageTimeView, showSenderName: showSenderName,
    ...
    class Coordinator: NSObject, UITableViewDataSource, UITableViewDelegate {
        ...
        init(
            ...
            showSenderName: Bool, messageLinkPreviewLimit: Int, messageFont: UIFont, sections: [MessagesSection],
